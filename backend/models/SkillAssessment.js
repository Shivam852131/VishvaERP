...
const skillAssessmentSchema = new mongoose.Schema({
  ...
  category: { type: String, enum: ['technical', 'aptitude', 'domain', 'soft_skill', 'coding', 'custom', 'cloud', 'language'], required: true },
  skillTags: [{ type: String, trim: true }],
  difficulty: { type: String, enum: ['easy', 'medium', 'hard', 'mixed', 'intermediate', 'advanced', 'beginner'], default: 'medium' },
